...
class esp01s {
	public:
		...
		/*
		 * @brief   Connects to the server using the ESP-01S module.
		 * @param 	server	The hostname or IP address of the server.
		 * @param 	port 	The port number of the MQTT broker as a string.
		 */
		void RA_ConnectToServer(const char *server, const char *port);
